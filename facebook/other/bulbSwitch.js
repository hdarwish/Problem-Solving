...
//- but among non - primes, there are some special numbers, perfect square numbers like 9 whose factors are(1, 9) and(3, 3) - odd - operation numbers,
// which means there will be only three different numbers that will affect the current bulb and result in bulb - on state!
...
//Sqrt(n) is the answer, since all square numbers that is less than n will be 1, 4, 9 ... n and 
//their corresponding square roots will be 1, 2, 3,... sqrt(n).
